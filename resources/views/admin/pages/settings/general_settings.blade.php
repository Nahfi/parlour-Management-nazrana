                        ...
                        <div class="col-12">
                            <form action="{{ route('admin.settings.general.post',$generalSettings->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-6 col-md-6 col-sm-12 mb-4">
                                        <div class="form-group">
                                            <label>Bin No.<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control @error('bin_number') is-invalid @enderror" value="{{ $generalSettings->bin_number }}" name="bin_number">
                                            @error('bin_number')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
