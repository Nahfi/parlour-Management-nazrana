                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.package.index') }}">All Package</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                         <div class="row align-items-center">
                          <form action="{{ route('admin.package.update',$product->id) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              <div class="row">
...
@section('admin_js')
    @if (Session::has('package_update_success'))
    <script>
            Toast.fire({
                icon: 'success',
